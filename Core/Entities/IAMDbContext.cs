...
public partial class IAMDbContext : DbContext
{
    ...
    public virtual DbSet<ArticleFournisseur> ArticleFournisseurs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ArticleFournisseur>(entity =>
        {
            entity.HasKey(e => new { e.Idarticle, e.Idfournisseur }).HasName("article_fournisseur_pkey");

            entity.ToTable("article_fournisseur");

            entity.Property(e => e.Idarticle).HasColumnName("idarticle");
            entity.Property(e => e.Idfournisseur).HasColumnName("idfournisseur");

            entity.HasOne(d => d.IdarticleNavigation).WithMany(p => p.ArticleFournisseurs)
                .HasForeignKey(d => d.Idarticle)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("article_fournisseur_idarticle_fkey");

            entity.HasOne(d => d.IdfournisseurNavigation).WithMany(p => p.ArticleFournisseurs)
        ...
        modelBuilder.Entity<Categorie>(entity =>
        {
            ...
            entity.HasIndex(e => e.Nom, "categorie_nom_key").IsUnique();
        ...
        modelBuilder.Entity<Commande>(entity =>
        {
            ...
            entity.Property(e => e.Totalcommande)
                .HasPrecision(18, 2)
        ...
        {
            entity.HasKey(e => e.Idlignecommande).HasName("ligne_commande_pkey");

            entity.ToTable("ligne_commande");

            entity.HasIndex(e => new { e.Idcommande, e.Idarticle }, "ligne_commande_idcommande_idarticle_key").IsUnique();

            entity.Property(e => e.Idlignecommande).HasColumnName("idlignecommande");
            entity.Property(e => e.Idarticle).HasColumnName("idarticle");
            entity.Property(e => e.Idcommande).HasColumnName("idcommande");
        ...
        modelBuilder.Entity<Facture>(entity =>
        {
            ...
            entity.HasIndex(e => e.Idcommande, "facture_idcommande_key").IsUnique();
        ...
        {
            entity.HasKey(e => e.Idlivraison).HasName("livraison_pkey");

            entity.ToTable("livraison");

            entity.HasIndex(e => e.Idcommande, "livraison_idcommande_key").IsUnique();
